...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOF, KICK_CHIP_Pin|KICK_LOW_Pin|KICK_CHARGE_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, LED_R_Pin|LED_G_Pin|LED_B_Pin|RX_EN_RADIO_0_Pin
                          |TX_EN_RADIO_0_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : KICK_CHIP_Pin KICK_LOW_Pin KICK_CHARGE_Pin */
  GPIO_InitStruct.Pin = KICK_CHIP_Pin|KICK_LOW_Pin|KICK_CHARGE_Pin;
  ...
  /*Configure GPIO pins : LED_R_Pin LED_G_Pin LED_B_Pin RX_EN_RADIO_0_Pin
                           TX_EN_RADIO_0_Pin */
  GPIO_InitStruct.Pin = LED_R_Pin|LED_G_Pin|LED_B_Pin|RX_EN_RADIO_0_Pin
                          |TX_EN_RADIO_0_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
