...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PC4     ------> ADC1_INP4
    */
    HAL_GPIO_DeInit(BAT_REF_GPIO_Port, BAT_REF_Pin);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB7     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(SCL_IMU_GPIO_Port, SCL_IMU_Pin);

    HAL_GPIO_DeInit(SDA_IMU_GPIO_Port, SDA_IMU_Pin);
  ...
  /* USER CODE END I2C2_MspDeInit 0 */
    ...
    PF1     ------> I2C2_SCL
    */
    HAL_GPIO_DeInit(SDA_OLED_GPIO_Port, SDA_OLED_Pin);

    HAL_GPIO_DeInit(SCL_OLED_GPIO_Port, SCL_OLED_Pin);
  ...
  /* USER CODE END I2C3_MspDeInit 0 */
    ...
    PA8     ------> I2C3_SCL
    */
    HAL_GPIO_DeInit(SDA_BTNS_GPIO_Port, SDA_BTNS_Pin);

    HAL_GPIO_DeInit(SCL_BTNS_GPIO_Port, SCL_BTNS_Pin);
  ...
  /* USER CODE END I2C4_MspDeInit 0 */
    ...
    PF15     ------> I2C4_SDA
    */
    HAL_GPIO_DeInit(SCL_NFC_GPIO_Port, SCL_NFC_Pin);

    HAL_GPIO_DeInit(SDA_NFC_GPIO_Port, SDA_NFC_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PB5     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, NSS_RADIO_1_Pin|SCK_RADIO_1_Pin);

    HAL_GPIO_DeInit(MISO_RADIO_1_GPIO_Port, MISO_RADIO_1_Pin);

    HAL_GPIO_DeInit(MOSI_RADIO_1_GPIO_Port, MOSI_RADIO_1_Pin);
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PD3     ------> SPI2_SCK
    */
    HAL_GPIO_DeInit(GPIOC, MOSI_RADIO_0_Pin|MISO_RADIO_0_Pin);

    HAL_GPIO_DeInit(NSS_RADIO_0_GPIO_Port, NSS_RADIO_0_Pin);

    HAL_GPIO_DeInit(SCK_RADIO_0_GPIO_Port, SCK_RADIO_0_Pin);
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PA7     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(GPIOA, ENCA_M4_Pin|ENCB_M4_Pin);
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PD13     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(GPIOD, ENCB_M1_Pin|ENCA_M1_Pin);
  ...
  /* USER CODE END TIM5_MspDeInit 0 */
    ...
    PA1     ------> TIM5_CH2
    */
    HAL_GPIO_DeInit(GPIOA, ENCA_M2_Pin|ENCB_M2_Pin);
  ...
  /* USER CODE END TIM23_MspDeInit 0 */
    ...
    PG13     ------> TIM23_CH2
    */
    HAL_GPIO_DeInit(GPIOG, ENCB_M3_Pin|ENCA_M3_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END UART4_MspDeInit 0 */
    ...
    PC11     ------> UART4_RX
    */
    HAL_GPIO_DeInit(GPIOC, RASP_TX_Pin|RASP_RX_Pin);
  ...
  /* USER CODE END UART7_MspDeInit 0 */
    ...
    PE7     ------> UART7_RX
    */
    HAL_GPIO_DeInit(ESC_TX_M1_GPIO_Port, ESC_TX_M1_Pin);

    HAL_GPIO_DeInit(ESC_RX_M1_GPIO_Port, ESC_RX_M1_Pin);
  ...
  /* USER CODE END UART9_MspDeInit 0 */
    ...
    PD15     ------> UART9_TX
    */
    HAL_GPIO_DeInit(GPIOD, ESC_RX_M2_Pin|ESC_TX_M2_Pin);
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PD6     ------> USART2_RX
    */
    HAL_GPIO_DeInit(ESC_TX_M3_GPIO_Port, ESC_TX_M3_Pin);

    HAL_GPIO_DeInit(ESC_RX_M3_GPIO_Port, ESC_RX_M3_Pin);
  ...
  /* USER CODE END USART6_MspDeInit 0 */
    ...
    PC7     ------> USART6_RX
    */
    HAL_GPIO_DeInit(GPIOC, ESC_TX_M5_Pin|ESC_RX_M5_Pin);
  ...
  /* USER CODE END USART10_MspDeInit 0 */
    ...
    PE3     ------> USART10_TX
    */
    HAL_GPIO_DeInit(GPIOE, ESC_RX_M4_Pin|ESC_TX_M4_Pin);
