...
Robo::Robo(uint8_t roboId) {
	...
	R_Kick = new Kick(CHIP_KICK_GPIO_Port, KICK_GPIO_Port, CHARGE_EN_GPIO_Port, CHIP_KICK_Pin, KICK_Pin, CHARGE_EN_Pin, &htim7, &htim10, &htim14, charge_time, recharge_time);
